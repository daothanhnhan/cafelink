        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ////////////// linh vuc web ///////////
                    case "linh-vuc-web":
                        include_once("template/linh-vuc-web/linh-vuc-web.php");
                        break;
                    case "them-linh-vuc-web":
                        include_once("template/linh-vuc-web/them-linh-vuc-web.php");
                        break;
                    case "sua-linh-vuc-web":
                        include_once("template/linh-vuc-web/sua-linh-vuc-web.php");
                        break;
                    ////////////// loai web ///////////////
                    case "loai-web":
                        include_once("template/loai-web/loai-web.php");
                        break;
                    case "them-loai-web":
                        include_once("template/loai-web/them-loai-web.php");
                        break;
                    case "sua-loai-web":
                        include_once("template/loai-web/sua-loai-web.php");
                        break;
                    //////////// hoan thien web ///////////
                    case "hoan-thien-web":
                        include_once("template/hoan-thien-web/hoan-thien-web.php");
                        break;
                    case "them-hoan-thien-web":
                        include_once("template/hoan-thien-web/them-hoan-thien-web.php");
                        break;
                    case "sua-hoan-thien-web":
                        include_once("template/hoan-thien-web/sua-hoan-thien-web.php");
                        break;
                    //////////////// loc theo loại muc ////
                    case "theo-muc-web":
                        include_once("template/san-pham/theo-muc-web.php");
                        break;
                    case "list-dang-web":
                        include_once("template/san-pham/list-dang-web.php");
                        break;
                    case "list-linh-vuc-web":
                        include_once("template/san-pham/list-linh-vuc-web.php");
                        break;
                    case "loc-tong-hop":
                        include_once("template/san-pham/loc-tong-hop.php");
                        break;
                    /////////////
                    case "them-danh-muc-linh-vuc":
                        include_once("template/danh-muc-linh-vuc/them-loai-san-pham.php");
                        break;

                    case "sua-danh-muc-linh-vuc":
                        include_once("template/danh-muc-linh-vuc/sua-loai-san-pham.php");
                        break;

                    case "danh-muc-linh-vuc":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-noi-dung.css' />";
                        include_once("template/danh-muc-linh-vuc/loai-san-pham.php");
                        break;
                    ///////////// newsletter //////////////
                    case "newsletter":
                        include_once("template/newsletter/newsletter.php");
                        break;
                    case "xoa-newsletter":
                        include_once("template/newsletter/xoa-newsletter.php");
                        break;
                    ///////////// Default /////////////////
                    default:
