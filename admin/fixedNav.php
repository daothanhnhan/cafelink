    ...
    <div class="contentFL">
        <ul class="listMenuFL">
            ...
            <li><a href="index.php?page=danh-muc-san-pham" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'danh-muc-san-pham' || $_GET["page"] == 'them-danh-muc-san-pham' || $_GET["page"] == 'sua-danh-muc-san-pham') {
                       echo 'sltMenu';
                                                                               ...
                                                                               class="iconMenu"/>Dạng web</a>
            </li>

            <li><a href="index.php?page=danh-muc-linh-vuc" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'danh-muc-linh-vuc') {
                       echo 'sltMenu';
                   } ?>"><img src="image/product2.png" class="iconMenu2"/><img src="image/product.png"
                                                                               class="iconMenu"/>Lĩnh vực web</a>
            </li>

            <li><a href="index.php?page=loai-web" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'loai-web') {
                       echo 'sltMenu';
                   } ?>"><img src="image/product2.png" class="iconMenu2"/><img src="image/product.png"
                                                                               class="iconMenu"/>Loại web</a>
            </li>

            <li><a href="index.php?page=hoan-thien-web" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'hoan-thien-web') {
                       echo 'sltMenu';
                   } ?>"><img src="image/product2.png" class="iconMenu2"/><img src="image/product.png"
                                                                               class="iconMenu"/>Mức độ hoạn thiện web</a>
            </li>
            ...
            <li><a href="index.php?page=san-pham" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'san-pham' || $_GET["page"] == 'them-san-pham' || $_GET["page"] == 'sua-san-pham') {
                       echo 'sltMenu';
                                                                               ...
                                                                               class="iconMenu"/>Danh sách web</a></li>

            <li><a href="index.php?page=theo-muc-web" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'theo-muc-web') {
                       echo 'sltMenu';
                   } ?>"><img src="image/product2.png" class="iconMenu2"/><img src="image/product.png"
                                                                               class="iconMenu"/>Lọc web theo mục</a>
            </li>
           ...
           <li><a href="index.php?page=lien-he" title=""
            ...
            <li><a href="index.php?page=newsletter" title=""
        ...
        if (isset($_GET["page"])) {
            switch ($_GET["page"]) {
                ...
                case "danh-muc-linh-vuc":
                    echo "<a href='index.php?page=them-danh-muc-linh-vuc' class='btnTop btnAddTop'>Thêm Mới</a>";
                    break;

                case "sua-danh-muc-linh-vuc":
                    echo "<a class='btnTop btnAddTop' href='index.php?page=danh-muc-linh-vuc'>Quay lại</a>";
                    echo "<a class='btnTop btnAddTop' href='index.php?page=them-danh-muc-linh-vuc'>Thêm mới</a>";
                    break;
