<?php 
    ...
    function addVideo () {
        ...
        if (isset($_POST['add_video'])) {
            ...
            $sql = "INSERT INTO hoan_thien_web (name, image, des, content, title, meta_des, meta_key, url) VALUES ('$name', '$image', ?, ?, '$title', '$meta_des', '$meta_key', '$url')";
            $stmt = $conn_vn->prepare($sql);
            $stmt->bind_param("ss", $des, $content);
            $stmt->execute();
            $id = $stmt->insert_id;
            echo '<script>alert(\'Bạn đã tạo danh mục video thành công.\');window.location.href="index.php?page=sua-hoan-thien-web&id='.$id.'";</script>';
        }
    }
    addVideo();
?>
...
<form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    <button class="btnAddTop" type="submit" name="add_video" style="position: fixed;top: 0;right: 220px;z-index: 9">Lưu</button>
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" id="title" onchange="ChangeToSlug()" name="name" required />
            
            <p class="titleRightNCP">Mô tả</p>
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1" name="des" ></textarea></p>
            <p class="titleRightNCP">Chi tiết</p>
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor2" name="content" ></textarea></p>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            <div>
                ...
                <input type="text" class="txtNCP1" placeholder="Điều khoản dịch vụ" name="title" id="title_seo" onkeyup="countChar(this)"/>
            </div>
            <div>
                <p class="titleRightNCP">Thẻ mô tả</p>
                <p class="subRightNCP"><strong class="text-character">0</strong>/160 ký tự</p>
                <textarea class="longtxtNCP2" name="meta_des" onkeyup="countChar(this)"></textarea>
            </div>
            <p class="titleRightNCP">Keyword</p>
            <input type="text" class="txtNCP1"  name="meta_key"/>
            <p class="titleRightNCP">Đường dẫn</p>
            <div class="coverLinkNCP">
                <div id="slug">
                    <input type="text" id="slug1" class="txtLinkNCP" name="url"/> 
                </div>    
            </div>
    ...
    <button type="submit" class="btn btnSave" name="add_video">Lưu</button>
