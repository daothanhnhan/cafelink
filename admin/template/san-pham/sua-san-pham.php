           ...
           <!--  <p class="titleRightNCP">Danh mục</p>
            ...
            <!-- <div class="subColContent">
                ...
                <select class="txtNCP1" name="linh_vuc_web_id" required>
                    ...
                    <option value="<?= $item['id'] ?>" <?= ($item['id']==$row['linh_vuc_web_id']) ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                    <?php } ?>
                </select>
            ...
            <div class="subColContent">
                ...
                <select class="txtNCP1" name="loai_web_id" required>
                    ...
                    <option value="<?= $item['id'] ?>" <?= ($item['id']==$row['loai_web_id']) ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                    <?php } ?>
                </select>
            ...
            <div class="subColContent">
                ...
                <select class="txtNCP1" name="hoan_thien_web_id" required>
                    ...
                    <option value="<?= $item['id'] ?>" <?= ($item['id']==$row['hoan_thien_web_id']) ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                    <?php } ?>
                </select>
